...
- [008 — README gốc dự án](steps/008-readme-goc-du-an.md)
- [009 — Logic so sánh STT vs kịch bản (IoU + `difflib`)](steps/009-logic-so-sanh-stt-vs-kich-ban.md)
- [010 — Package `src/kzen`, `pip install -e .`](steps/010-package-src-kzen.md)
